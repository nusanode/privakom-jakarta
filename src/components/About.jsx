      ...
      <div>
        ...
        <div className="lg:w-1/2 w-full">
          ...
          <p className="text-lg text-gray-600 font-medium mb-8 leading-relaxed">
            ...
            {" "}dengan materi yang dapat disesuaikan dengan kebutuhan
            tim dan bidang pekerjaan. Training dapat dilaksanakan di
            lokasi perusahaan di berbagai wilayah Indonesia.
          </p>
          ...
          <div className="space-y-3 mb-9">
            ...
            <div className="flex items-center gap-4 p-4 rounded-2xl bg-gray-50 border border-gray-100">
              ...
              <span className="text-dark font-bold">
                In House Training dapat dilaksanakan secara nasional
              </span>
