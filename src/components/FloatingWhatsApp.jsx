...
const FloatingWhatsApp = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 lg:bottom-10 lg:right-10 z-50 flex flex-col items-end">
      ...
      {showBranches && (
        <div className="mb-4 w-64 bg-white rounded-3xl shadow-2xl border border-gray-100 p-2 flex flex-col gap-1">
          ...
          <a
            ...
            className="flex items-center gap-3 px-4 py-3 rounded-2xl hover:bg-emerald-50 hover:text-emerald-600 font-bold transition-all"
          >
            {/* IKON WHATSAPP HIJAU */}
