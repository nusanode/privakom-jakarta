  ...
  <div className="px-6 lg:px-12 max-w-8xl mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 border-b border-white/10 pb-16">
      ...
      <div className="lg:col-span-2 pr-0 lg:pr-12">
        ...
        Privakom merupakan lembaga pelatihan komputer profesional yang menyediakan 

          

        kursus Microsoft Office, Excel, Power BI, AutoCAD, Desain Grafis, Web Design, 

          

        Teknisi Komputer, Networking, Cyber Security, serta Inhouse Training Perusahaan di Indonesia. 
