  ...
  return (
    <section id="students" className="py-24 bg-white w-full overflow-hidden">
      <div className="px-6 lg:px-12 max-w-8xl mx-auto">
        ...
        {/* BAGIAN HEADER TESTIMONI - Sudah Bersih dari Bahasa Inggris */}
        <div className="text-center mb-16 md:mb-24">
          ...
          <h2 className="text-5xl lg:text-7xl font-black text-dark mb-8 leading-tight drop-shadow-sm tracking-tight">
            Apa Kata
            <br />
            Alumni Kami.
          </h2>
          ...
          <p className="text-xl text-gray-600 font-medium max-w-2xl mx-auto leading-relaxed">
            Dengarkan kisah para lulusan kami yang telah berhasil meningkatkan keterampilan digital 
            dan mengembangkan karier mereka bersama Privakom.
          </p>
        </div>

        {/* STRUKTUR ELEMEN ANIMASI MARQUEE */}
